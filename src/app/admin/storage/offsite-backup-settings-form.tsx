...
import { updateOffsiteBackupSettingsAction } from "@/app/admin/storage/actions";
...
export function OffsiteBackupSettingsForm({ configVolumePath, settings }: OffsiteBackupSettingsFormProps) {
