...
import { OctagonX, RefreshCw, Wrench } from "lucide-react";
...
export function RaveWarRepairControls({ stalled, status, warId }: RaveWarRepairControlsProps) {
  ...
  return (
    <section className="rounded-md border border-bc-amber/40 bg-bc-panel" aria-labelledby="rave-war-repair-heading">
      ...
      <div className="grid divide-y divide-bc-line lg:grid-cols-2 lg:divide-x lg:divide-y-0">
