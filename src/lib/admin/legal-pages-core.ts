...
const legalPageDefaults = [
  {
    body:
      "Bouncecore stores account details, profile information, purchases, downloads, chat activity, stream interactions, notification preferences, and device notification tokens where needed to run the platform.\n\nPayment details are handled by PayPal and Square where enabled. Bouncecore stores payment references, order status, shipping details, digital download entitlements, wallet credits, and fulfilment records, but does not store full card details.\n\nThe Android app may use Firebase Cloud Messaging for push notifications and Unity LevelPlay for advertising when enabled. Non-essential advertising is controlled by the app privacy choices and website cookie choices.\n\nUploaded files, chat messages, moderation reports, support requests, and account actions may be reviewed by authorised staff to operate the service, investigate abuse, process purchases, and keep the community safe.\n\nYou can request access, export, correction, restriction, objection, or privacy review at /privacy/requests. You can delete or request deletion from account settings. If you cannot sign in, use the public account deletion request page at /account/delete. Some records may need to be retained for security, fraud prevention, payment, tax, or legal obligations.\n\nYou can contact the site operator using the public support details shown on this site.",
    enabled: true,
    href: "/privacy",
    key: "privacy",
  ...
  {
    body:
      "Bouncecore uses essential cookies and local storage for sign-in sessions, security, account preferences, cart state, chat behaviour, checkout, and app/web functionality.\n\nOptional analytics, marketing, advertising, and preference storage should only run when enabled through the privacy choices manager. Third-party providers may process identifiers or transaction references when their services are used, including PayPal checkout and payouts, Square checkout, Firebase push notifications, Tenor GIF search, Unity LevelPlay ads, or other integrations enabled by the site operator.\n\nBlocking essential cookies may prevent login, purchases, chat, downloads, or other account features from working correctly. You can update cookie choices from the privacy choices control on the site.",
    enabled: true,
    href: "/cookies",
    key: "cookies",
    title: "Cookie Policy"
