...
- Fixed Core FPS startup stalls by streaming large mod-data assets through the signed gateway instead of buffering them into its bounded temporary filesystem.
